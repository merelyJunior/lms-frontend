      ...
      <div className="my-[50px] h-[184px] max-w-maxContentTab lg:max-w-maxContent">
        ...
        >
          {reviews.map((review, i) => {
            return (
              <SwiperSlide key={i}>
                <div className="flex flex-col gap-3  p-3 text-[14px]  min-h-[180px] max-h-[180px] glass-bg">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      <h1 className="font-semibold text-white capitalize">{`${review?.user?.firstName} ${review?.user?.lastName}`}</h1>
                      <h2 className="text-[12px] font-medium text-white00">
