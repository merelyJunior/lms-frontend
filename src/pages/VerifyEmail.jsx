          ...
          (
            <div className="max-w-[500px] p-4 lg:p-8">
              ...
              <form onSubmit={handleVerifyAndSignup}>
                <OtpInput
                  ...
                  renderInput={(props) => (
                    <input
                      ...
                      className="w-[48px] lg:w-[60px] border-0  rounded-[0.5rem] text-white aspect-square text-center focus:border-0 focus:outline-2 focus:outline-yellow-50"
                    />
                  )}
                  containerStyle={{
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-50 text-black py-[12px] px-[12px] rounded-[8px] mt-6 font-medium "
                >
                  Verify Email
                </button>
              </form>
